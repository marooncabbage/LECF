...
class ManifoldParameter(Parameter):
    ...
    """
    def __new__(cls, data, requires_grad, manifold, c): # https://zhuanlan.zhihu.com/p/21379984
    ...
    def __repr__(self): #https://segmentfault.com/a/1190000022266368
        return '{} Parameter containing:\n'.format(self.manifold.name) + super(Parameter, self).__repr__() # https://realpython.com/python-super/
